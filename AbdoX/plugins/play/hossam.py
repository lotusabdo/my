...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/3a7d6cd84a83d0956d3f6.jpg",
        caption=f"""✅ مرحبا بك عزيزي {message.from_user.mention}
     
✅ اليك قائمة اوامر سورس رالزو
•𝅼▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•▬▭࣪▬•
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼", callback_data=f"devhelp"),
                ],[
                    InlineKeyboardButton(
...
async def ayamr(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""✅ اليك قائمة اوامر سورس رالزو
•▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•▬▭࣪▬•

✅ قائمه الاوامر تحتوي علي ٢ اوامر .
•𝅼▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•𝅼▬▭࣪▬•
1 ← اوامـر الـحـمـايـه .
...
•𝅼▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•𝅼▬▭࣪▬•""",reply_markup=InlineKeyboardMarkup(
            [
                [
                      InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼", callback_data=f"devv"),
                ],[
                    InlineKeyboardButton(
...
6 ← اوامر الادمن .""",
       reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    InlineKeyboardButton(
                        "𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼", callback_data=f"devmusic"),
                ],[
                    InlineKeyboardButton(
               "رجـوع ♬", callback_data=f"ayamr"),
               ],
...
async def tt(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""ٓ[ٓ♡ | 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑹𝑨𝑳𝒁𝑶𝑶𝑶 .](https://t.me/SOU_LOFFY_RCE)
...
•𝅼▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•𝅼▬▭࣪▬•
✅ هذه قائمه مميزات سورس رالزو الميوزك .
•𝅼▬▭࣪▬•| 𝗦𝗼𝘂𝗿𝗰𝗲 𝗿𝗮𝗹𝘇𝗼𝗼𝗼 |•𝅼▬▭࣪▬•
- لعرض اوامر البوت اكتب : الاوامر .
- لعرض كليشه السورس اكتب : سورس رالزو .
...
async def devhelp(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""[ٓ♡ | 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑹𝑨𝑳𝒁𝑶𝑶𝑶 .](https://t.me/SOU_LOFFY_RCE)\n\n[♡ | 𝑹𝑨𝑳𝒁𝑶𝑶𝑶 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑺𝑶𝑼𝑹𝑪𝑬 𝑶𝑵 𝑻𝑬𝑳𝑬 .](https://t.me/SOU_LOFFY_RCE)\n\n[♡ | 𝑭𝑶𝑳𝑳𝑶𝑾 𝑻𝑯𝑬 𝑩𝑼𝑻𝑻𝑶𝑵𝑺 𝑩𝑬𝑳𝑶𝑾 .](https://t.me/SOU_LOFFY_RCE)""",
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "𝐃𝐚𝐝 𝐀𝐡𝐦𝐞𝐝 𝐀𝐥𝐦𝐬𝐫𝐲", url=f"https://t.me/DAD_AH7"),
                    InlineKeyboardButton(
